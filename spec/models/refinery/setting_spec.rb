  ...
  describe Setting do
    ...
    context 'set' do
      ...
      it 'should default to form_value_type text_area' do
        @set = ::Refinery::Setting.set(:creating_from_scratch, {:value => 'a value', :scoping => 'rspec_testing'})
        ::Refinery::Setting.find_by(name: :creating_from_scratch.to_s, scoping: 'rspec_testing').form_value_type.should eq('text_area')
      end
      ...
      it "should fix true as a value to 'true' (string)" do
        ...
        ::Refinery::Setting.find_by(name: :creating_from_scratch.to_s, scoping: 'rspec_testing')[:value].should eq(true)
        set.should eq(true)
      end
      ...
      it "should fix false as a value to 'false' (string)" do
        ...
        ::Refinery::Setting.find_by(name: :creating_from_scratch.to_s, scoping: 'rspec_testing')[:value].should eq(false)
        set.should eq(false)
      end
